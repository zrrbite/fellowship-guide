# Silken Hollow — Adventure (1 boss)

**Boss:** Vexira, Mother of Nightmares · **Length:** 10-15 min · **Difficulty:** A — easy

**Drops:** Death's Grasp (DPS), Sin Warding (all)

Minimal group damage, few forced interrupts, and diverse pathing to sidestep dangerous packs. The
boss is mechanically forgiving. A good second-favourite farm after the two Heskyr dungeons.

## Route

At the fork after the opening trash packs, **take the right path**. Both routes contain the same mob
types in different combinations, so this is a preference, not a requirement — but pick one and keep
it.
...
A Mass Dispel relic is well spent in this dungeon if someone is carrying one.
